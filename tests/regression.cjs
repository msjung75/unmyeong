...
(async () => {
  ...
  console.log('PASS: syntax, age/luck boundaries, lunar and unknown time, correction, 12 solar-term intervals, UI controls, PDF privacy, shared-link confirmation, backup cancellation');
  w.close();
